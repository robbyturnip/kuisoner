...
<html>
  <head>
    ...
    <link href="{{ URL::asset('template/gentelella/dist/jqvmap.css" media="screen" rel="stylesheet" type="text/css">

    <script type="text/javascript" src="http://code.jquery.com/jquery-1.11.3.min.js"></script>
    <script type="text/javascript" src="{{ URL::asset('template/gentelella/dist/jquery.vmap.js"></script>
    <script type="text/javascript" src="{{ URL::asset('template/gentelella/dist/maps/jquery.vmap.world.js" charset="utf-8"></script>
